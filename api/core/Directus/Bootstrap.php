...
use Directus\Webhooks\Emitter as WebhooksEmitter;
...
class Bootstrap
{
    ...
    /**
     * Construct Webhooks Provider - Should be called only after authentication
     * @return \Directus\Webhooks\Emitter
     */
	private static function webhooks()
	{
        ...
        $emitter = new WebhooksEmitter($acl, $db);
